...
public class SQLiteDatabase extends SQLiteClosable {
   ...
   */
    ...
    public void changePassword(String password) throws SQLiteException {
        ...
        native_rekey(getBytes(password.toCharArray()));
    }
    ...
    public void changePassword(char[] password) throws SQLiteException {
        ...
        native_rekey(getBytes(password));
    }
   ...
   */
    ...
    public static void loadLibs (Context context, File workingDir) {
        System.loadLibrary("grandtechDB");
    }
    ...
    public void rawExecSQL(String sql){
        Log.d("nativeSQL","rawExecSQL:"+sql);
        long timeStart = SystemClock.uptimeMillis();
        lock();
        if (!isOpen()) {
            throw new IllegalStateException("database not open");
    ...
    private native void native_key(byte[] key) throws SQLException;

    private native void  native_rekey(byte[] key) throws SQLException;
