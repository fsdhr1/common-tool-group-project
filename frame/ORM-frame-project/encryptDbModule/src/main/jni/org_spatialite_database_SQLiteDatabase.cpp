...
namespace spatialite {
  ...
  void native_key_char(JNIEnv* env, jobject object, jbyteArray jKey) {
      int rc = 0;
      int index = 0;
      jsize size = 0;
      jbyte *key = 0;
  ...
  void native_rekey_str(JNIEnv* env, jobject object, jbyteArray jKey) {
      int rc = 0;
      jsize size = 0;
      jbyte *key = 0;
      sqlite3 *handle = NULL;
  ...
  static JNINativeMethod sMethods[] =
    {
      ...
      {"native_key", "([B)V", (void *)native_key_char},
      //{"native_rekey", "([C)V", (void *)native_rekey_char},
      {"native_rekey", "([B)V", (void *)native_rekey_str},
    };
