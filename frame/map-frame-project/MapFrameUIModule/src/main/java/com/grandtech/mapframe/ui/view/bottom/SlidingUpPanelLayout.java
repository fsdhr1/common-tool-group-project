package com.grandtech.mapframe.ui.view.bottom;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.map_frame_ui_panel_bottom_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.map_frame_ui_panel_bottom_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
    ...
    public boolean isTouchEnabled() {
        //System.out.println("mIsTouchEnabled:" + mIsTouchEnabled + "|mSlideState:" + mSlideState);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (Math.abs(dx) > Math.abs(dy)) {
                ...
                //System.out.println("dispatchTouchEvent>>>>>>>>左右滑动忽略");
                return super.dispatchTouchEvent(ev);
            }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                //System.out.println("ady" + ady + "|dragSlop" + dragSlop);
        ...
        //System.out.println("onInterceptTouchEvent>>>>>>>>>>>" + mSlideState);
        if (mSlideState != null && mSlideState == PanelState.EXPANDED) {
            return super.onInterceptTouchEvent(ev);  //有问题请取消注释
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (isSuperTouchEvent() || !isTouchEnabled() || !isEnabled()) {
    ...
    public boolean isSuperTouchEvent() {
        boolean b = mDragHelper.isDragging();
        return !b;
    }
