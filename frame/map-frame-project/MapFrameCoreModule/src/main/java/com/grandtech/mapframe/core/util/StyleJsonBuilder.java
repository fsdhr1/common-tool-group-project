    ...
    public StyleJsonBuilder() {
        try {
            ...
            String satelliteSourceStr = String.format("{\n" +
                    ...
                    "             \"maxzoom\": %s,\n" +
                    "            \"tileSize\":256\n" +
                    "        }", "http://a.tiles.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZ3lraiIsImEiOiJjbDA5YjBjYzIwYmc4M2pwOXd4dHh3Mzc5In0.54AifzzOuqzO5M3f75zt1A",16);
