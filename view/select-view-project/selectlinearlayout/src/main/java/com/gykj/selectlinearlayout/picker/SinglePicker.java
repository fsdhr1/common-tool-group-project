package com.gykj.selectlinearlayout.picker;
...
import com.gykj.selectlinearlayout.util.ConvertUtils;
import com.gykj.selectlinearlayout.view.WheelView;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    public static SinglePicker getSinglePicker(Activity activity, List items, int index){
        SinglePicker singlePicker = new SinglePicker(activity,items);
        singlePicker.setCanceledOnTouchOutside(false);
        singlePicker.setSelectedIndex(index);
    ...
    public void setWheelViewShowItem(Integer i){
