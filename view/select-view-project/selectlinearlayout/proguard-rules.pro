...
# 保留类和类中的public方法、public static变量不被混淆
-keep public class com.gykj.selectlinearlayout.SelectLinearLayout {
    public *;
    public static <fields>;
}

# 保留接口和接口中的方法不被混淆
-keep public interface com.gykj.selectlinearlayout.SelectLinearLayout$ISelectDict {
    *;
}

# 保留实体类不被混淆
-keep class com.gykj.selectlinearlayout.bean.** {
    *;
}
