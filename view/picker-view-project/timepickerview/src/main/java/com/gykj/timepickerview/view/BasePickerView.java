...
import com.gykj.timepickerview.listener.OnDismissListener;
import com.gykj.timepickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void createDialog() {
        if (dialogView != null) {
            ...
            mDialog.getWindow().setGravity(Gravity.BOTTOM);// 设置显示在底部
