...
import com.gykj.timepickerview.listener.CustomListener;
import com.gykj.timepickerview.view.BasePickerView;
import com.gykj.timepickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private View viewTitleDivider;// 标题下方分割线
    ...
    private int Title_Height;//标题高度
    private boolean isShowTitleDivider;//是否显示标题下方分割线

    private int Size_Submit_Cancel;//确定取消按钮字体大小
    ...
    public TimePickerView(Builder builder) {
        ...
        this.Title_Height = builder.Title_Height;
        this.isShowTitleDivider = builder.isShowTitleDivider;
    ...
    public static class Builder {
        ...
        private int Size_Submit_Cancel = 17;//确定取消按钮字体大小
        ...
        // 设置标题高度
        public Builder setTitleHeight(int title_Height) {
            this.Title_Height = title_Height;
            return this;
        }

        // 是否显示标题下方分割线
        public Builder setShowTitleDivider(boolean showTitleDivider) {
            isShowTitleDivider = showTitleDivider;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            // 设置标题高度
            if (Title_Height != 0) {
                ViewGroup.LayoutParams layoutParams = rv_top_bar.getLayoutParams();
                layoutParams.height = Title_Height;
                rv_top_bar.setLayoutParams(layoutParams);
            }

            // 标题下方分割线
            viewTitleDivider = findViewById(R.id.viewTitleDivider);
            if (isShowTitleDivider) {
                viewTitleDivider.setVisibility(View.VISIBLE);
                if (dividerColor != 0)
                    viewTitleDivider.setBackgroundColor(dividerColor);
            } else {
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_CANCEL) & Str_Cancel.equals("长期")) {
