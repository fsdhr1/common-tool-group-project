...
import com.gykj.timepickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_SUBMIT)) {
            ...
            if(optionsSelectListener == null) dismiss();
            else {
                optionsSelectListener.onCancelClick(this);
            }
        }
    ...
    public interface OnOptionsSelectListener {
        ...
        default void onCancelClick(OptionsPickerView pickerView){
            pickerView.dismiss();
        }
