...
# 保留指定包下的类不被混淆
-keep class com.gykj.base.adapter.** {*;}
-keep class com.gykj.utils.** {*;}
-keep class com.gykj.cameramodule.bean.** {*;}

-keep class com.gykj.cameramodule.activity.image.ImageViewPager {
    public *;
}

-keep class com.gykj.cameramodule.activity.image.ImgPickActivity {
    public *;
}

-keep class com.gykj.cameramodule.activity.camera.CameraActivity {
    public *;
}
