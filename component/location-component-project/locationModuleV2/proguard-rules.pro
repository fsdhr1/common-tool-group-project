...
-keep class com.gykj.location.LocationClient {
    public *;
}

-keep class com.gykj.location.ServiceLocation {
    *;
}
...
# 实体类和接口不被混淆
-keep class com.gykj.location.beans.**{*;}
-keep class com.gykj.location.interfaces.**{*;}
#枚举类不被混淆
-keep enum **{*;}
# 抽象方法名称不能被混淆，防止重写
-keepclassmembers class com.gykj.location.base.BaseService{*;}
