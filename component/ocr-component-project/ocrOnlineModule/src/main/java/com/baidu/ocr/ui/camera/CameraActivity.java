...
public class CameraActivity extends AppCompatActivity {
    ...
    private void initNative(final String token) {
        CameraNativeHelper.init(CameraActivity.this, OCR.getInstance(this).getLicense(),
    ...
    private View.OnClickListener lightButtonOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH)) {
                Toast.makeText(CameraActivity.this, "您的设备没有闪光灯!", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            CameraThreadPool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if (outputFile != null && outputFile.exists() && outputFile.isFile())
                        intent.putExtra(KEY_OUTPUT_FILE_PATH, outputFile.getAbsolutePath());
