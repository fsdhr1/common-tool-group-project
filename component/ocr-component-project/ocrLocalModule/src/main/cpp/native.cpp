...
Java_com_grandtech_ocrlib_OCRPredictorNative_init(
...
Java_com_grandtech_ocrlib_OCRPredictorNative_forward(
...
Java_com_grandtech_ocrlib_OCRPredictorNative_release(
